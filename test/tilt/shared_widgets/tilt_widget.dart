...
class TiltBaseWidget extends StatelessWidget {
  const TiltBaseWidget({
    super.key,
    this.childLayout = const ChildLayout(),
    this.tiltStreamController,
    this.disable = false,
...
class TiltProjectorWidget extends StatelessWidget {
  const TiltProjectorWidget({
    super.key,
    this.childLayout = const ChildLayout(),
    this.tiltStreamController,
    this.disable = false,
    ...
    this.clipBehavior = Clip.antiAlias,
    this.tiltConfig = const TiltConfig(),
    this.lightConfig = const LightProjectorConfig(disable: false),
