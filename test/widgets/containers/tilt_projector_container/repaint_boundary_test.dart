...
void main() {
  group('TiltProjectorContainer :: RepaintBoundary ::', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        /// 初次渲染时会调用 2 次 paint (Projector 内部会导致 2 次)，之后动画过程中每帧至少调用一次
        expect(innerPaintCount, 2 + frameCount);
